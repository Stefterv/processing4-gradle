...
public interface ProcessingListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ProcessingParser#warnMixedModes}.
	 * @param ctx the parse tree
	 */
	void enterWarnMixedModes(ProcessingParser.WarnMixedModesContext ctx);
	/**
	 * Exit a parse tree produced by {@link ProcessingParser#warnMixedModes}.
	 * @param ctx the parse tree
	 */
	void exitWarnMixedModes(ProcessingParser.WarnMixedModesContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link ProcessingParser#baseStringLiteral}.
	 * @param ctx the parse tree
	 */
	void enterBaseStringLiteral(ProcessingParser.BaseStringLiteralContext ctx);
	/**
	 * Exit a parse tree produced by {@link ProcessingParser#baseStringLiteral}.
	 * @param ctx the parse tree
	 */
	void exitBaseStringLiteral(ProcessingParser.BaseStringLiteralContext ctx);
	/**
	 * Enter a parse tree produced by {@link ProcessingParser#multilineStringLiteral}.
	 * @param ctx the parse tree
	 */
	void enterMultilineStringLiteral(ProcessingParser.MultilineStringLiteralContext ctx);
	/**
	 * Exit a parse tree produced by {@link ProcessingParser#multilineStringLiteral}.
	 * @param ctx the parse tree
	 */
	void exitMultilineStringLiteral(ProcessingParser.MultilineStringLiteralContext ctx);
	/**
	 * Enter a parse tree produced by {@link ProcessingParser#stringLiteral}.
	 * @param ctx the parse tree
	 */
	void enterStringLiteral(ProcessingParser.StringLiteralContext ctx);
	/**
	 * Exit a parse tree produced by {@link ProcessingParser#stringLiteral}.
	 * @param ctx the parse tree
	 */
	void exitStringLiteral(ProcessingParser.StringLiteralContext ctx);
	/**
